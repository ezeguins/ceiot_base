...
startDatabase().then(async() => {
    await insertMeasurement({id:'00', t:'18', h:'78', p:'5'});
    await insertMeasurement({id:'00', t:'19', h:'77', p:'4'});
    await insertMeasurement({id:'00', t:'17', h:'77', p:'3'});
    await insertMeasurement({id:'01', t:'17', h:'77', p:'2'});
